...
loader.crossOrigin = '';
loader.load('http://www.radiolights.com/CODEPEN/b-grasslight-big2.jpg', function(texture) {
    diffuseTexture1 = texture;
    loadTextures();
    applyShader(THREE.LuminosityShader, diffuseTexture1, specularMap);
});

loader.load('http://www.radiolights.com/CODEPEN/b-backgrounddetailed62.jpg', function(texture) {
    diffuseTexture2 = texture;
    loadTextures();
});

loader.load('http://www.radiolights.com/CODEPEN/b-grasslight-big-nm2.jpg', function(texture) {
